...
export class AccountAssetState {
   ...
   * ```
   */
  assetMintingProof(keys: AccountKeys, path: AccountLeafPathAndRoot, amount: any): AssetMintingProof;
  /**
   ...
   * ```
   */
  senderRevertProof(keys: AccountKeys, path: AccountLeafPathAndRoot, settlement_ref: any, leg_id: number, leg_enc: SettlementLegEncrypted, asset_id: number, amount: any): SenderReversalProof;
  /**
...
export class AssetState {
   ...
   * ```
   */
  constructor(asset_id: number, mediators: any, auditors: any);
  /**
...
export class SenderReversalProof {
   ...
   * ```
   */
  static fromBytes(bytes: Uint8Array): SenderReversalProof;
  /**
   * Exports the proof as a hex-encoded string.
   *
   * # Returns
   ...
   * ```
   */
  static fromHex(hex_str: string): SenderReversalProof;
  /**
   * Exports the proof as a SCALE-encoded byte array.
   *
   * # Returns
