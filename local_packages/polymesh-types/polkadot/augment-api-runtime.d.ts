...
import type { AccountId, Balance, Block, Call, Header, Index, KeyTypeId, Perbill, Slot, Weight, WeightV2 } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api-base/types/calls' {
    interface AugmentedCalls<ApiType extends ApiTypes> {
        ...
        assetApi: {
             ...
             **/
            transferReport: AugmentedCall<ApiType, (sender_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, receiver_portfolio: PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array, asset_id: PolymeshAssetId | string | Uint8Array, transfer_value: Balance | AnyNumber | Uint8Array, skip_locked_check: bool | boolean | Uint8Array) => Observable<Vec<DispatchError>>>;
        };
        ...
        identityApi: {
             ...
             **/
            getFilteredAuthorizations: AugmentedCall<ApiType, (signatory: Signatory | {
                Identity: any;
            } | {
                Account: any;
        ...
        settlementApi: {
             ...
             **/
            getAffirmationCount: AugmentedCall<ApiType, (instruction_id: InstructionId | AnyNumber | Uint8Array, portfolios: Vec<PortfolioId> | (PortfolioId | {
                did?: any;
                kind?: any;
            } | string | Uint8Array)[]) => Observable<AffirmationCount>>;
            /**
             ...
             * Returns a vector containing all errors for the transfer. An empty vec means there's no error.
             **/
            getTransferReport: AugmentedCall<ApiType, (leg: Leg | {
                Fungible: any;
            } | {
                NonFungible: any;
            } | {
             ...
             **/
            instructionAssetCount: AugmentedCall<ApiType, (instruction_id: InstructionId | AnyNumber | Uint8Array) => Observable<AssetCount>>;
            /**
             * Returns the weight for executing lock_instruction.
             **/
            lockInstructionWeight: AugmentedCall<ApiType, (instruction_id: InstructionId | AnyNumber | Uint8Array) => Observable<Result<Weight, DispatchError>>>;
        };
